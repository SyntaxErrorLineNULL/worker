...
func (_m *Task) GetError() <-chan error {
	ret := _m.Called()
...
func (_c *Task_GetError_Call) Return(_a0 <-chan error) *Task_GetError_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Task_GetError_Call) RunAndReturn(run func() <-chan error) *Task_GetError_Call {
	_c.Call.Return(run)
	return _c
}

// Run provides a mock function with given fields: workerTimeout
func (_m *Task) Run(workerTimeout time.Duration) {
	_m.Called(workerTimeout)
}
...
func (_e *Task_Expecter) Run(workerTimeout interface{}) *Task_Run_Call {
	return &Task_Run_Call{Call: _e.mock.On("Run", workerTimeout)}
}

func (_c *Task_Run_Call) Run(run func(workerTimeout time.Duration)) *Task_Run_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Task_Run_Call) RunAndReturn(run func(time.Duration)) *Task_Run_Call {
	_c.Run(run)
	return _c
}
