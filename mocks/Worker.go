...
// GetRetry provides a mock function with no fields
...
// IsStop provides a mock function with no fields
func (_m *Worker) IsStop() bool {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for IsStop")
	}
...
// Worker_IsStop_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsStop'
type Worker_IsStop_Call struct {
	*mock.Call
}

// IsStop is a helper method to define mock.On call
func (_e *Worker_Expecter) IsStop() *Worker_IsStop_Call {
	return &Worker_IsStop_Call{Call: _e.mock.On("IsStop")}
}

func (_c *Worker_IsStop_Call) Run(run func()) *Worker_IsStop_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Worker_IsStop_Call) Return(_a0 bool) *Worker_IsStop_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Worker_IsStop_Call) RunAndReturn(run func() bool) *Worker_IsStop_Call {
	_c.Call.Return(run)
	return _c
}
